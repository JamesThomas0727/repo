...
const PostCard = () => {
    ...
    const [class1, setClass1] = useState("e-card e-business e-PostCard");
    const [isFlipped2, setisFlipped2] = useState(true);
    const [class2, setClass2] = useState("e-card e-business e-PostCard");
    const PostCard1 = () => {
        setisFlipped1(!isFlipped1);
        setClass1(isFlipped1 ? 'e-card e-business e-PostCard e-PostCardped' : 'e-card e-business e-PostCard');
    };
    const PostCard2 = () => {
        setisFlipped2(!isFlipped2);
        setClass2(isFlipped2 ? 'e-card e-business e-PostCard e-PostCardped' : 'e-card e-business e-PostCard');
    };
    return (<div className='control-pane'>
        <div className='control-section card-control-section PostCard_card_layout'>
            <div className="e-card-resize-container">
                <div className='row'>
                    <div className="row card-layout">
                        <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                            <div className={class1} id="card_PostCard" onClick={PostCard1} title="Click to PostCard the Card">
                        ...
                        <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                            <div className={class2} id="card_PostCard_profile" onClick={PostCard2} title="Click to PostCard the Card">
                                <div className="e-card-header e-back">
                                    <div className="e-card-header-caption">
                                        <div className="e-card-header-title">Address</div>
                                        <div className="e-card-sub-title">
